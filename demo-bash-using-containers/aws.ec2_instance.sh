...
columns="account_id,arn,disable_api_termination,iam_instance_profile_arn,image_id,instance_id,instance_state,instance_status,instance_type,key_name,launch_time,monitoring_state,partition,placement_availability_zone,private_dns_name,public_ip_address,region,security_groups,subnet_id,title,tags,vpc_id"
